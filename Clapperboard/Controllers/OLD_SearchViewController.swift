...
class OLD_SearchViewController: UIViewController {
...
extension OLD_SearchViewController : UICollectionViewDataSource {
...
extension OLD_SearchViewController {
...
extension OLD_SearchViewController: UICollectionViewDelegate {
...
extension OLD_SearchViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        case .searchResults: return CGSize(width: collectionView.bounds.width / 2.5, height: (collectionView.bounds.width / 2.5) / 3 * 5)
...
extension OLD_SearchViewController: UITextFieldDelegate {
...
//
//extension OLD_SearchViewController: SearchHeaderDelegate {
//    
...
extension OLD_SearchViewController: OMDbAPIConnectorDelegate {
